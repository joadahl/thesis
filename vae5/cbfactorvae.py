...
class cbfactor(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        print(
            ...
            "and mean val_loss is {:7.2f}." "and tc_reg is {:7.2f}" "and KL is {:7.2f}" "and disc_loss is {:7.2f}".format(
                epoch, logs["loss"], logs["val_loss"], logs["tc_reg"], logs["KL"], logs["disc_loss"]
            )
        )
    """
